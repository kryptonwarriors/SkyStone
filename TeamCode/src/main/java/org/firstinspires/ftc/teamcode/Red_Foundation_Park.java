    ...
    public void loop() {
        ...
        switch (CurrentState) {
            ...
            case GO_RIGHT_TO_FOUNDATION:
                if ( ( (Math.abs(Math.abs(LeftForward.getCurrentPosition()) - Math.abs(350)) <= THRESH)) )
                {
            ...
            case GET_CLOSE_TO_PARK:
                if ( ( (Math.abs(Math.abs(LeftForward.getCurrentPosition()) - Math.abs(800)) <= THRESH)) )
                {
                    StopDrive();
                    ...
                    telemetry.addData("LeftDistanceSensor", LeftDistance.getDistance(DistanceUnit.INCH));
                    telemetry.update();
                }
            case MOVE_LEFT:
                ...
                break;
            case MOVE_UP:
                if ( ( (Math.abs(Math.abs(LeftForward.getCurrentPosition()) - Math.abs(300)) <= THRESH)) )
                {
                    telemetry.addData("LeftForward Encoder",LeftForward.getCurrentPosition());
                    telemetry.update();
                    StopDrive();
            ...
            case MOVE_LEFT_TO_SKYBRIDGE:
                if ( ( (Math.abs(Math.abs(LeftForward.getCurrentPosition()) - Math.abs(400)) <= THRESH)) )
                {
                    telemetry.addData("LeftForward Encoder",LeftForward.getCurrentPosition());
                    telemetry.update();
                    StopDrive();
                ...
                break;
            case PARK_DOWN:
                if ( ( (Math.abs(Math.abs(LeftForward.getCurrentPosition()) - Math.abs(900)) <= THRESH)) )
                {
                    telemetry.addData("LeftForward Encoder",LeftForward.getCurrentPosition());
                    telemetry.update();
                    StopDrive();

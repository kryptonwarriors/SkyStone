...
public class DritAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        runtime.reset ();
        if (opModeIsActive ()) {
            if (Objects.equals ( SkyStonePos, "Left" )) {

            }
            if (Objects.equals ( SkyStonePos, "Center" )) {

            }
            if (Objects.equals ( SkyStonePos, "Right" )) {
    ...
    private void DriveWithPID(int direction, double power, int TargetPosition) {
        ...
        while (opModeIsActive () && Math.abs ( LeftForward.getCurrentPosition () ) < Math.abs (
                LeftForward.getTargetPosition () )) {
            ...
            telemetry.addData ( "reached TargetPos?",
                                Math.abs ( LeftForward.getCurrentPosition () ) < Math.abs (
                                        LeftForward.getTargetPosition () ) );
            telemetry.update ();
